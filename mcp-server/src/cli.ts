...
program
  ...
  .option('-p, --port <port>', 'Server port', (val) => parseInt(val), parseInt(process.env.PORT || process.env.CURUPIRA_PORT || '8080'))
  .option('-h, --host <host>', 'Server host', process.env.HOST || process.env.CURUPIRA_HOST || 'localhost')
